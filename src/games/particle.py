...
class Particle(CoordConverter):
    ...
    def __init__(
        ...
        if settings.randomness and not all_none:
            ...
            self._velocity = settings.default_velocity
    ...
    def update_position(self):
        ...
        y += y_velocity
        self.position = (x, y)
        self.box.center = self.convert_x_to_px(x)
        self.box.bottom = self.convert_y_to_px(y)
    ...
    def _get_box(self):
        ...
        center, bottom = self.convert_internals_to_px(self.position)
        width, height = self.convert_internals_to_px(self.dimensions)
    ...
    def _determine_velocity(
        ...
        if abs_velocity is not None:
            ...
            velocity = Settings.default_velocity
        return velocity
    ...
    def _randomize_velocity(
        ...
        v_absolute = v_absolute + v_rand_adjust
        return v_absolute
